  ...
  vi: {
    ...
    tech: {
      ...
      rows: [
        ...
        { label: 'AI Engine', value: 'Google GenAI (Gemini 2.5 Flash), Tự kết nối AI (BYOK OpenAI/Anthropic)' },
        { label: 'Billing',   value: 'ZeroInvoice API VietQR Napas EMVCo, Hệ thống Coupon chiết khấu % tự động' },
      ],
    },
    security: {
      title: 'Bảo mật & Phân quyền',
      desc: 'Dữ liệu người dùng được bảo vệ bởi RLS (Row-Level Security) trên Neon Postgres. Mỗi user chỉ có thể truy cập dữ liệu của chính mình. Admin được xác thực qua biến môi trường',
      env: 'ADMIN_EMAIL',
