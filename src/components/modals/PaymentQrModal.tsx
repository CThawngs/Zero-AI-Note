...
interface PaymentQrModalProps {
  ...
  billData: {
    ...
    /** Payee confirmation from Zero Tracking (app-fixed bank account) */
    payee?: {
...
export const PaymentQrModal: React.FC<PaymentQrModalProps> = ({
  ...
  const activePayee = billData?.payee && billData.payee.accountNo
    ? billData.payee
    : (billData?.qr_data
        ? { accountNo: billData.qr_data.accountNo, bankName: billData.qr_data.bankName, accountName: billData.qr_data.accountName }
        : null);
