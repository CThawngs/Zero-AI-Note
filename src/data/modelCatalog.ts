...
export const SYSTEM_GEMINI_MODELS: ModelCatalogItem[] = [
  ...
  },
  {
    ...
    provider: 'Google AI (Free Pool)',
    providerId: 'google-system',
    descVi: 'Bản nâng cấp thế hệ mới, tối ưu độ chính xác và trích xuất học thuật',
    descEn: 'Next-gen upgrade with optimized precision for academic structuring',
    isSystem: true,
    status: 'active',
  },
  {
  ...
  },
  {
    ...
    provider: 'Google AI (Free Pool)',
    providerId: 'google-system',
    descVi: 'Cửa sổ ngữ cảnh khổng lồ 2 triệu tokens cho sách và tài liệu dài',
    descEn: 'Massive 2M token context window for full books and lengthy materials',
    isSystem: true,
    status: 'active',
  },
  {
    ...
    provider: 'Google AI (Free Pool)',
    providerId: 'google-system',
    descVi: 'Mô hình Flash ổn định và cân bằng tốt giữa tốc độ và chất lượng',
    descEn: 'Stable and well-balanced Flash model for everyday note-taking',
    isSystem: true,
    status: 'active',
  },
  {
    ...
    provider: 'Google AI (Free Pool)',
    providerId: 'google-system',
    descVi: 'Thế hệ mô hình 3.0 thử nghiệm với kiến trúc xử lý ma trận mới',
    descEn: 'Experimental 3.0 generation preview with next-generation matrix processing',
    isSystem: true,
    status: 'active',
  },
  {
    ...
    provider: 'Google AI (Free Pool)',
    providerId: 'google-system',
    descVi: 'Mô hình 3.1 Pro phục vụ phân tích tài liệu học thuật chuyên sâu',
    descEn: 'Advanced 3.1 Pro preview for rigorous deep academic document analysis',
    isSystem: true,
    status: 'active',
  },
  {
    ...
    provider: 'Google AI (Free Pool)',
    providerId: 'google-system',
    descVi: 'Mô hình Flash thế hệ 3.5 tiên tiến nhất',
    descEn: 'Next-generation 3.5 Flash architecture with state-of-the-art efficiency',
    isSystem: true,
    status: 'active',
  },
  {
    ...
    provider: 'Google AI (Free Pool)',
    providerId: 'google-system',
    descVi: 'Mô hình đa nhiệm kết hợp suy luận phân tích tự điều chỉnh linh hoạt',
    descEn: 'Hybrid reasoning model with dynamically scalable thinking depth',
    isSystem: true,
    status: 'active',
  },
];
